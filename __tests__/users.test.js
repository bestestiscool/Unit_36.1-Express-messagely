...
describe("Test User class", function () {
  ...
  test("can register", async function () {
    ...
    expect(u.password).not.toBe("password"); // Ensure password is hashed
  });
  ...
  test("can authenticate", async function () {
    ...
    await expect(User.authenticate("test", "xxx")).rejects.toThrow('Invalid username/password');
  });
  ...
  test("can get", async function () {
    ...
    expect(u).toEqual({
      ...
      last_login_at: null, // Ensure it handles null correctly
    });
  });
